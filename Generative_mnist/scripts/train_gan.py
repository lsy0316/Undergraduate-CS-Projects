...
"""训练 DCGAN 风格 GAN。
用法：python scripts/train_gan.py --epochs 50 --z-dim 100
"""
import argparse
import os
import sys
...
from pytorch_generative_mnist.models.gan import Generator, Discriminator
...
def main():
    ...
    train_gan(cfg, G, D, train_loader, resume_ckpt=resume, conditional=False)
